...
from custom_llama_index.readers.weaviate.data_structs import WeaviateNode
from custom_llama_index.readers.weaviate.utils import get_default_class_prefix
...
class WeaviateVectorStore(VectorStore):
    ...
    def add(
        ...
        WeaviateNode.from_custom_llama_index_batch(
    ...
    def query(
        ...
        """
        nodes = WeaviateNode.to_custom_llama_index_list(
            self.client,
            self._class_prefix,
