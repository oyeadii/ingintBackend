...
from custom_llama_index.indices.query.embedding_utils import get_top_k_embeddings
...
class SimpleVectorStoreData(DataClassJsonMixin):
    ...
    text_id_to_doc_metadata: Dict[str, Any] = field(default_factory=dict)
...
class SimpleVectorStore(VectorStore):
    ...
    def add(
        ...
        for result in embedding_results:
            ...
            self._data.text_id_to_doc_metadata[text_id] = result.doc_metadata
